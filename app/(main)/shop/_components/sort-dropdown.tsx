...
export function SortDropdown() {
  ...
  return (
    <div className="flex items-center gap-1">
      <label htmlFor="sort-select" className="text-base font-semibold text-[#3E3E59]">
        Sort By:
      </label>
      <Select value={currentSort} onValueChange={handleSortChange}>
        ...
        <SelectContent alignItemWithTrigger={false}>
          <SelectItem value="default" className="cursor-pointer text-base font-medium">
            Default
          </SelectItem>
          <SelectItem value="price-asc" className="cursor-pointer text-base font-medium">
            Low to High
          </SelectItem>
          <SelectItem value="price-desc" className="cursor-pointer text-base font-medium">
            High to Low
          </SelectItem>
        </SelectContent>
      </Select>
