  ...
  return (
    <>
      ...
      <Container className="py-6 lg:py-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            {topBlogs.map(blog => (
              <TopBlogCard
                ...
                date={blog.published_at ? format(new Date(blog.published_at), "d MMM yyyy") : format(new Date(blog.created_at), "d MMM yyyy")}
        ...
        {/* recent articles  */}
        {isFirstPage && recentBlogs.length > 0 && (
          <RecentArticles articles={recentBlogs} />
        )}
