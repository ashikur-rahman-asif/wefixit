  ...
  if (!blog) {
    return (
      <div className="flex flex-col h-[400px] items-center justify-center text-center">
        <h3 className="text-lg font-semibold text-titleBlack mb-2">Blog not found</h3>
  ...
  return (
    <div className="bg-[#F8F9FB] min-h-screen p-6">
      <div className="mb-6">
        ...
        <h1 className="text-[24px] font-bold text-titleBlack leading-none mb-1">Edit Blog</h1>
        <p className="text-textGray text-sm">Update the blog details</p>
      </div>
