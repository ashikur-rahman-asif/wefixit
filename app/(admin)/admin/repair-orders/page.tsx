              ...
              {isLoading ? (
                ...
                repairs.map((repair: AdminRepair) => (
                  <TableRow
                    ...
                    <TableCell className="px-6 py-4">
                      <div className="font-bold text-titleBlack text-sm whitespace-nowrap">
                        {repair.customerName}
                      </div>
                      <div className="text-textGray text-xs font-semibold whitespace-nowrap">
                        {repair.email || "N/A"}
                      </div>
                    </TableCell>
                    <TableCell className="px-6 py-4">
                    ...
                    <TableCell className="px-6 py-4 text-textGray text-sm font-semibold">
                      {repair.scheduledDate
                        ? dayjs(repair.scheduledDate).format("MMM D, YYYY")
                        : "N/A"}
                    </TableCell>
        ...
        {meta && meta.lastPage > 1 && (
          <div className="px-6 py-4 border-t border-gray-100 bg-gray-50/50 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm font-semibold text-textGray">
              Showing <span className="text-titleBlack">{meta.from}</span> to{" "}
              <span className="text-titleBlack">{meta.to}</span> of{" "}
              <span className="text-titleBlack">{meta.total}</span> repairs
            </p>
