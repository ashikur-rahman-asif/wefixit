...
import { useRepairs } from "@/hooks/admin/use-repairs";
import { Trash2 } from "lucide-react";
import { DeleteConfirmationModal } from "@/components/admin/DeleteConfirmationModal";
import { getOrderStatusColor } from "@/lib/utils";
import { useDeleteRepair } from "@/hooks/admin/use-repair";
              ...
              {isLoading ? (
                ...
                repairs.map((repair: AdminRepair) => (
                  ...
                  >
                    ...
                    <TableCell className="px-6 py-4">
                      <div className="font-bold text-titleBlack text-sm">{repair.customerName}</div>
                      <div className="text-textGray text-xs font-semibold">{repair.email || "N/A"}</div>
                    </TableCell>
                    <TableCell className="px-6 py-4">
                    ...
                    <TableCell className="px-6 py-4 font-semibold text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          href={`/admin/repairs/${repair.reference}`}
