...
import { useAdminRepair, useUpdateRepair, useDeleteRepair } from "@/hooks/admin/use-repair";
    ...
    return (
      <div className="p-6 md:p-10 max-w-[1600px] mx-auto min-h-[60vh] flex items-center justify-center">
        <div className="flex flex-col items-center justify-center text-textGray">
          ...
          <Link href="/admin/repairs" className="text-brand hover:underline font-semibold">
