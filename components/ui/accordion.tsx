    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronRightIcon
          ...
          className="pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden text-secondary"
        />
        <ChevronUpIcon
          data-slot="accordion-trigger-icon"
          className="pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline text-secondary"
        />
      </AccordionPrimitive.Trigger>
