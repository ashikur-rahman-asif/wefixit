          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left w-full">
            ...
            <div className="hidden lg:flex items-center gap-6 mt-8">
              <div className="flex items-center gap-2">
                ...
                <p className="text-base text-white font-medium">Genuine Products</p>
              </div>
              <div className="flex items-center gap-2">
                <RoundedTickIcon className="w-[18px] h-[18px] text-white" />
                <p className="text-base text-white font-medium">Expert Repair Service</p>
              </div>
              <div className="flex items-center gap-2">
                <RoundedTickIcon className="w-[18px] h-[18px] text-white" />
                <p className="text-base text-white font-medium">Fast & Secure Delivery</p>
              </div>
            </div>
          </div>
